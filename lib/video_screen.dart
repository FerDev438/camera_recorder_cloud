                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text("CITYSURVEY by CITYDATA", style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold),),
                      ),
                    ...
                    child: Column(
                      children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(child: Center(child: Text("Video", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18),)))
                          ],
                        ),
                        ),
                              ...
                              child: GestureDetector(
                                ...
                                child: Center(
                                  child: Container(
                                    ...
                                    ? const Icon(Icons.play_arrow, color: Color.fromARGB(255, 255, 23, 7), size: 40,) 
                                    : const Icon(Icons.stop, color: Color.fromARGB(255, 255, 23, 7), size: 40,),
